...
await conn.sendMessage(m.chat, { text: m.isWABusiness.toString() }, { quoted: m })
...
break
default:
if (!/[01]/.test(command)) return await conn.sendMessage(m.chat, { text: `\`${lenguajeGB.smsConfi10()}\`\n\n🌟 ${lenguajeGB.smsConfi2()} *@${toUser}*
...
${wm}`, mentions: [aa] }, { quoted: m })
//conn.sendList(m.chat, `${listMessage.text}\n`, listMessage.footer, `${listMessage.buttonText}`, sections, null, null, fkontak);
throw false
}
await conn.sendMessage(m.chat, { text: `${lenguajeGB['smsAvisoRG']()}ღ *_${lenguajeGB['smsMens1']()}_* *|* ${type} 
ღ *_${lenguajeGB['smsMens2']()}_* *|* ${isEnable ? lenguajeGB.smsEncender() : lenguajeGB.smsApagar()} 
ღ *_${lenguajeGB['smsMens3']()}_* *|* ${isAll ? lenguajeGB.smsMens4() : isUser ? '' : lenguajeGB.smsMens5()}` }, { quoted: m })
