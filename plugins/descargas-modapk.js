...
text: `${lenguajeGB['smsAvisoMG']()} ${mid.smsApk}`
}, { quoted: m });
return;
}
try {    
...
await conn.sendMessage(m.chat, {text: 'Error: No se encontraron datos'}, {quoted: m});
return;
}
...
await conn.sendMessage(m.chat, { 
text: `Ocurrió un error temporal, intenta nuevamente...\n\n${wm}` 
}, { quoted: m });
