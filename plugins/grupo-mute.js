...
if (!_0x21af21) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0x9a)}, {quoted: _0x4960d9})
return
}
const _0x1facb5 = global['owner'][0x0][0x0] + _0x82d6a1(0x83)
if (_0x4960d9[_0x82d6a1(0x87)][0x0] === _0x1facb5) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: '😼\x20*El\x20creador\x20del\x20bot\x20no\x20puede\x20ser\x20mutado*'}, {quoted: _0x4960d9})
return
}
...
: _0x577e36
if (_0x8acb16 === _0x1d1981[_0x82d6a1(0x9b)][_0x82d6a1(0x93)]) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0xa6)}, {quoted: _0x4960d9})
return
}
...
if (_0x4960d9[_0x82d6a1(0x87)][0x0] === _0x2dc357) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0x91)}, {quoted: _0x4960d9})
return
}
...
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x5da6a1}, {quoted: _0x4960d9})
return
}
if (_0x2c1dd9[_0x82d6a1(0x96)] === !![]) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0x7e)}, {quoted: _0x4960d9})
return
}
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0x8d), mentions: [_0x8acb16]}, {quoted: _0x571e77})
global['db'][_0x82d6a1(0x99)][_0x82d6a1(0xa2)][_0x8acb16][_0x82d6a1(0x96)] = !![]
} else {
if (_0x2159df === 'unmute') {
if (!_0x21af21) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: '👑\x20*Solo\x20un\x20administrador\x20puede\x20ejecutar\x20este\x20comando'}, {quoted: _0x4960d9})
return
}
...
if (_0x581bd4 === _0x4960d9[_0x82d6a1(0xa3)]) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0xa4)}, {quoted: _0x4960d9})
return
}
if (!_0x4960d9[_0x82d6a1(0x87)][0x0] && !_0x4960d9[_0x82d6a1(0x94)]) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x17fcd1}, {quoted: _0x4960d9})
return
}
if (_0x5e6d75[_0x82d6a1(0x96)] === ![]) {
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0x9c)}, {quoted: _0x4960d9})
return
}
global['db'][_0x82d6a1(0x99)][_0x82d6a1(0xa2)][_0x581bd4][_0x82d6a1(0x96)] = ![]
await _0x1d1981.sendMessage(_0x4960d9.chat, {text: _0x82d6a1(0x80), mentions: [_0x581bd4]}, {quoted: _0x55c898})
}
}
}
function _0x4397() {
